...
import { filters, singleFilter } from './FilterData.jsx'
...
import kurta from "../../../Data/Kurta/kurta.js"
const sortOptions = [
  ...
  return (
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto  px-4 sm:px-6 lg:px-21">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5 ">
              {/* Filters */}
              <div>
                <div className='py-10 flex gap-2 items-center justify-between'>
                <h1 className=' text-lg opacity-50 font-bold flex flex-col'>Filters</h1>
                <FilterListIcon/>
                </div>
                  ...
                  <Disclosure as="div" key={section.id} className="border-b border-gray-200 py-6">
                    {({ open }) => (
                     <>
                        <h3 className="-my-3 flow-root">
                          <Disclosure.Button className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                            <FormLabel sx={{color:"black"}} className="font-medium " id="demo-radio-buttons-group-label">{section.name}</FormLabel>
                            <span className="ml-6 flex items-center">
                              {open ? (
                                <MinusIcon className="h-5 w-5" aria-hidden="true" />
                              ) : (
